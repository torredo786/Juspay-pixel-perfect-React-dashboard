        ...
        <div className={`order-list`}>
            ...
            <div className="toolbar" style={{ background: isDarkMode ? "#FFFFFF0D" : "#F7F9FB" }}>
                <div>
                    ...
                    <span className="btn"><SortIcon /></span>
            ...
            {filteredOrders.length > rowsPerPage && (
                <div className="pagination">
                    <button disabled={currentPage === 1} onClick={() => setCurrentPage(p => p - 1)} className={`${isDarkMode ? "lightmode-text" : "darkmode-text"}`}>{"<"}</button>
                    ...
                    <button disabled={currentPage === totalPages} onClick={() => setCurrentPage(p => p + 1)} className={`${isDarkMode ? "lightmode-text" : "darkmode-text"}`}>{">"}</button>
                </div>
            )}
        </div>
    );
